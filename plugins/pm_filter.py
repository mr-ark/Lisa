...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>𝙸𝚏 𝚈𝚘𝚞 𝚆𝚊𝚗𝚝 𝙰𝚗𝚢 𝙼𝚘𝚟𝚒𝚎 𝙿𝚕𝚎𝚊𝚜𝚎 𝚁𝚎𝚚𝚞𝚎𝚜𝚝 𝙾𝚗 @Moviegroup_TG</b>")
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 Support 💠', url='https://t.me/CodeHouse_TG'),
            InlineKeyboardButton('🎥 Movie Updates 🎥', url='https://t.me/MovieHouse_TG')
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('👨‍💻 Dᴇᴠᴏʟᴏᴘᴇʀ', url=f"https://t.me/adwin_mosses"),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/ark_xh")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
